...
* `cidr_range`: Required. Canonical CIDR range for the ODB Subnet; the address must be the network address for the prefix.
...
* ODB Subnet CIDR ranges must be valid canonical CIDR blocks whose address is the network address.
